...
def process_song_file(cur, filepath):
    """
    Open the json file, insert the record for song and artist table
    """
...
def process_log_file(cur, filepath):
    """
    Open the log file, filter the table by next song. Convert the timestamp and inserting the time records
    """
    df = pd.read_json(filepath,lines = True)
